...
const textInputClass =
  "min-h-12 w-full rounded-xl border border-white/10 bg-white/5 px-4 text-sm text-white outline-none transition placeholder:text-slate-500 focus:border-indigo-300/60";
const numberInputClass =
  "min-h-12 w-full rounded-xl border border-white/10 bg-white/5 px-4 text-sm text-white outline-none transition focus:border-indigo-300/60";
  ...
  return (
    <section className="border-t border-white/10 pt-6">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        ...
        <Button className="w-full sm:w-auto" disabled={disabled} onClick={onAdd} type="button" variant="secondary">
          {addLabel}
        </Button>
      </div>
  ...
  return (
    <AppShell active="settings">
      <section className="px-4 py-6 sm:px-10 sm:py-8 lg:px-12">
        ...
        <div className="grid max-w-5xl gap-5 sm:gap-6">
          <Card className="p-5 sm:p-6">
            ...
            <form className="mt-6 flex flex-col gap-3 sm:flex-row" onSubmit={handleSaveName}>
              <input
                ...
                value={nameInput}
              />
              <Button className="w-full sm:w-auto" disabled={nameSyncInProgress || nameInput.trim() === (userFullName ?? "")} type="submit">
            ...
            {activeLessonDraft ? (
              <div className="mt-6 grid gap-6">
                ...
                <EditableList<string>
                  ...
                  renderItem={(sentence, index) => (
                    <label className="grid gap-2 text-sm text-slate-300 sm:col-span-2">
                      Sentence
                      <textarea
                        className="min-h-24 w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-white outline-none transition placeholder:text-slate-500 focus:border-indigo-300/60"
                        disabled={lessonInputSyncInProgress}
                        onChange={(event) =>
                          updateSummaryDraft((draftSummary) => ({
                            ...draftSummary,
                ...
                <div className="flex flex-col gap-3 rounded-2xl border border-white/10 bg-white/[0.03] p-4 sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <Button className="w-full sm:w-auto" disabled={lessonInputSyncInProgress} onClick={() => void handleSaveLessonInputs()} type="button">
          ...
          <Card className="p-5 sm:p-6">
            ...
            <LogoutButton className="mt-5 w-full justify-center sm:w-auto" />
          </Card>

          <Card className="border-rose-400/25 bg-[linear-gradient(180deg,rgba(76,5,25,0.72),rgba(28,10,24,0.9))] p-5 sm:p-6">
            ...
            <div className="mt-5 flex flex-col gap-3 sm:flex-row">
              ...
              />
              <Button
                className="w-full border-rose-200/25 bg-rose-500 text-white shadow-[0_0_24px_rgba(244,63,94,0.25)] hover:bg-rose-400 sm:w-auto"
